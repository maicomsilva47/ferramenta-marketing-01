...
const ResultadosPage = () => {
  ...
  // Parse the diagnostic data from URL parameter
  let diagnosticoData: { overall: string; evaluation: string; date: string } | null = null;
  let error = false;
  ...
  // Format the evaluation label based on the value
  ...
  // Get the background color class for the progress bar
